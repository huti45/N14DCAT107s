...
public class LSBStegGui extends javax.swing.JFrame {

    private static String sourceFilePath = "";
    private static String fileName = "";
    private LSBSteg s = new LSBSteg();
    /**
     * Creates new form LSBStegGui
     */
    public LSBStegGui() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("HoanSon Steganography");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LSBStegGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LSBStegGui().setVisible(true);
            }
        });
    }
